...
func (r *countReporter) Report(ctx context.Context, userID entity.UserID, document *mission.Document) (mission.Results, error) {
	...
	for _, dm := range document.DataList {
		...
		rm := service.NewReflectCounterMissionStatus(um, mps, p)
